...
The YOLO dataset output means you can immediately do:
    yolo train data=D:/OrangIdentifier/V2/WILD_CROPS/yolo_dataset/data.yaml
...
---
    ...
    python D:\OrangIdentifier\V2\scripts\V2_3_extract_faces_wild.py
"""
...
CROPS_DIR       = V2_BASE / "WILD_CROPS" / "crops"
JSON_PATH       = V2_BASE / "WILD_CROPS" / "boxes_wild.json"
...
# CNRS IPHC Strasbourg — {datetime.now().strftime('%Y-%m-%d')}
#
